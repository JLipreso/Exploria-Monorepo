/**
 * Firebase Configuration - Staff Portal
 * 
 * This file initializes Firebase for the Exploria Staff Portal
 * Configuration values are loaded from environment variables
 * 
 * Location: frontend/staff-portal/src/firebase.ts
 */
...
if (import.meta.env.DEV) {
  console.log('✅ Firebase initialized successfully for Staff Portal');
}
