/**
 * Firebase Configuration - Operator Portal
 * 
 * This file initializes Firebase for the Exploria Operator Portal
 * Configuration values are loaded from environment variables
 * 
 * Location: frontend/operator-portal/src/firebase.ts
 */
...
if (import.meta.env.DEV) {
  console.log('✅ Firebase initialized successfully for Operator Portal');
}
